...
Welcome! This repository is my **personal Excel projects portfolio**. It contains practical projects that showcase my skills in **data analysis, dashboard creation, and reporting**. Each project demonstrates how to work with real-world data and analyze it effectively, highlighting my expertise in using Excel as a powerful analytical tool.
